...
extension Text {
  ...
  /// let completion = try await client.call(Text.Completions(
  ...
  /// - [Text Completion Guide](https://platform.openai.com/docs/guides/completion)
  /// - [Code Completion Guide](https://platform.openai.com/docs/guides/code)
  ...
  public struct Completions: JSONPostCall {
    ...
    /// ID of the model to use. You can use ``Models/List`` to see all of your available models, or see the [Model overview](https://platform.openai.com/docs/models/overview) for descriptions of them.
