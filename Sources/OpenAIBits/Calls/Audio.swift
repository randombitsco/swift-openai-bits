...
extension Audio {
  ...
  public struct Transcriptions: MultipartPostCall {
    ...
    /// The filename (no path) for the data being uploaded. Must have one of the supported extensions.
    ...
    public func getForm() throws -> MultipartForm {
      var parts: [MultipartForm.Part] = [
          .init(name: "file", data: file, filename: fileName, contentType: "application/octet-stream"),
