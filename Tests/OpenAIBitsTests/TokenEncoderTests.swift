...
final class TokenEncoderTests: XCTestCase {
  ...
  func testGPT3SimpleText() throws {
    ...
    let tokens: [Token] = [1212, 318, 617, 2420, 13]
  ...
  func testFailingDecode() throws {
    let tokens: [Token] = [43, 150000] // 150000 is well above the token boundary for GPT-3 and will fail.
  ...
  func testEncodeMultibyteText() throws {
    let text = "🇺🇸"
    let tokens: [Token] = [8582, 229, 118, 8582, 229, 116]
